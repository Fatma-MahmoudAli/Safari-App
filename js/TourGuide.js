...
require([
    ...
    const view = new mapView({
      map: _map,
      center: [25, 29], //Longitude, latitude
      zoom: 5,
      container: "mapdiv",
    });
    ...
    const pFeatureLayer = new FeatureLayer({
      url: "https://services3.arcgis.com/U26uBjSD32d7xvm2/arcgis/rest/services/Tourguide1/FeatureServer",
      outFields: ["*"],
  ...
  function submit(Graphic, pFeatureLayer) {
    ...
    let Langueges = document.getElementById("Language");
